...
class stack {
	...
	double* tab;
		...
		// elements between current_size and
		// are not initialized.
	void ensure_capacity( size_t c );
		// Ensure that stack has capacity of
		// at least c.
public:
	...
	void pop( );
		...
		// code that crashes, as long as you write clearly what are // your preconditions, so:
		// PRECONDITION: The stack is not empty.
	void reset( size_t s );
		// Pops element until stack has size s. // PRECONDITION: s <= current_size.
	double& top( ); double top( ) const;
